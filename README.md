...
<b>Please refer to and cite these articles when you use BayesFactorFMRI:</b>
 0. Han, H. (in pre). BayesFactorFMRI: Implementing Bayesian second-level fMRI analysis with multiple comparison correction and Bayesian meta-analysis of fMRI images with multiprocessing. *Journal of Open Research Software*. (current available via bioRxiv: https://bit.ly/34t7555)
